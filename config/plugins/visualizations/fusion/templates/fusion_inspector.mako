...
<head>
    ...
    <!-- inspector css -->
    <link rel="stylesheet" type="text/css" href="${h.url_for('/plugins/visualizations/fusion_inspector/static/css/inspector.css')}">
...
<body>
   ...
   %>
    ...
    <!-- Scripts -->
    <script src="${h.url_for('/plugins/visualizations/fusion_inspector/static/FusionInspector.js')}"></script>
    <script>
